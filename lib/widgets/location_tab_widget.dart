...
// DONE Besides setting the active location (which it is already doing)
// DONE Add that location to a saved loations list (you'll need to create this)
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        LoctionInputWidget(setLocation: (loc) {widget._setLocation; _addLocation(loc);}),
